...
| `KB_OPENAI_API_KEY` | `langchain_knowledge_base` 独立知识库智能体的 OpenAI-compatible chat 和 embedding 调用 | `src/agents/langchain_knowledge_base/.env` |
...
- 真实开发密钥: `.env.local`
- 独立知识库智能体真实配置: `src/agents/langchain_knowledge_base/.env`
- 可提交模板: `.env.example`
- 独立知识库智能体模板: `src/agents/langchain_knowledge_base/.env.example`
